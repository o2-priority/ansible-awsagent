...
# O2: override metadata for integration testing
...
AGENT_ID_PARAM="x-installer-version=1.1.1446.0&x-existing-version=${EXISTING_AGENT_VERSION}&x-uniq-os-id=${UNIQ_OS_ID}&x-instance-type=${METADATA_INSTANCE_TYPE}"
...
echo "This install script was created to install agent version:1.1.1446.0"
